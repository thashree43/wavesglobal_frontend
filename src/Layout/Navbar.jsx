  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 px-6 py-4 bg-gradient-to-r from-slate-900/95 to-slate-800/95 backdrop-blur-lg shadow-xl border-b border-white/10">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <button className="relative overflow-hidden px-6 py-2 rounded-lg font-semibold bg-gradient-to-r from-amber-400 to-yellow-500 text-slate-900 hover:from-yellow-500 hover:to-amber-400 transition-all duration-300 transform hover:scale-105 hover:shadow-lg group">
